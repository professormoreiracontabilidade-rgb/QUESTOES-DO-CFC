const CACHE='questoes-cfc-quiz-v5';
const ASSETS=['./','index.html','style.css','app.js','manifest.json','logo.png','icones/icon-192.png','icones/icon-512.png',...Array.from({length:50},(_,i)=>`imagens/${String(i+1).padStart(2,'0')}.png`)];
